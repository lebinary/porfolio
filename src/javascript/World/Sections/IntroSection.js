...
export default class IntroSection
{
    ...
    setTitles()
    {
        ...
        this.objects.add({
            ...
            offset: new THREE.Vector3(-1.85, -9.5, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
            soundName: 'brick'
        ...
        this.objects.add({
            ...
            offset: new THREE.Vector3(0, -9.5, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
            soundName: 'brick'
        ...
        this.objects.add({
            ...
            offset: new THREE.Vector3(1, -9.5, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
            soundName: 'brick'
        ...
        // })
        this.objects.add({
            base: this.resources.items.introEngineerBase.scene,
            collision: this.resources.items.introEngineerCollision.scene,
            offset: new THREE.Vector3(0, -1, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.3 },
            mass: 1.5,
